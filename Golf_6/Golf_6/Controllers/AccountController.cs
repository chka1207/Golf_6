...
namespace Golf_6.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [HttpPost]
        public ActionResult Login(AccountModels.LoginViewModel model, string returnUrl)
        {
           ...
           try
            {
                ...
                Postgres x = new Postgres();
                x.SqlParameters("update loginkonto set salt=@par2, key=@par3 where agare =@par1", Postgres.lista = new List<NpgsqlParameter>()
                {
